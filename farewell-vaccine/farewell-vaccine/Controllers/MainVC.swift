...
extension MainVC: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        switch row {
        case 0:
            self.showViewController(fileName: "Main", viewController: UINavigationController.self, storyboardId: "HomeNC")
        case 1:
            self.showViewController(fileName: "FVTest", viewController: UINavigationController.self, storyboardId: "FVTestNC")
        case 2:
            self.showViewController(fileName: "Introduce", viewController: UINavigationController.self, storyboardId: "IntroduceNC")
        case 3:
            self.showViewController(fileName: "LoveAdvice", viewController: UINavigationController.self, storyboardId: "LoveAdviceNC")
        case 4:
            self.showViewController(fileName: "Setting", viewController: UINavigationController.self, storyboardId: "SettingNC")
        default:
            break
        }
    ...
    func showViewController<T: UIViewController>(fileName: String, viewController: T.Type, storyboardId: String) -> () {
